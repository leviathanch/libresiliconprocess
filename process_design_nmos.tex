...
So we target a surface concentration of $10^{16}\frac{1}{cm^3}=10^{22}\frac{1}{m^3}$ which gives us margin of error in case of temperature variations and too long diffusion.

The depletion zone thickness at its peak will be $W_{dmax} \approx 2.73 \cdot 10^{-7} m = 273 nm$ so making the well $\approx 2 \mu m$ is ok.

$\approx 2 \mu m$ come mainly from the need to fulfill the condition from \autoref{physics_drive_in}
