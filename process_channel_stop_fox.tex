...
On top of the channel stop impurities is a thick layer of silicon oxide which has the primary function of isolation all the transistors from each other.
