...
\begin{figure}[H]
	...
	\end{tikzpicture}
	\caption{Channel stop and field oxide}
	\label{channelstop_fox_target}
\end{figure}
...
The top view and cross section of the targeted geometry can be seen in \autoref{channelstop_fox_target}.
