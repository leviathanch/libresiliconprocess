...
\newpage
\input{physics_threshold_overview.tex}
\input{physics_threshold_metal.tex}
\input{physics_threshold_poly.tex}
...
\newpage
\input{testing_diodes.tex}
\newpage
\input{testing_bipolars.tex}
\newpage
...
\section{Machines}
\input{machines_overview.tex}
\input{machines_mask_maker.tex}
\input{machines_litho_stepper.tex}
\input{machines_thermal_RTAAG610.tex}
\newpage
\input{machines_dry_DRIE.tex}
\input{machines_silicon_polisher.tex}
\input{machines_copper_polisher.tex}
\newpage
\input{machines_trion_RIE_etch.tex}
\input{machines_diffusion_furnace.tex}
\input{machines_denton_sputter.tex}
\newpage
\input{machines_LPCVD.tex}
\input{machines_poly_etcher.tex}
\newpage
\section{Resists}
