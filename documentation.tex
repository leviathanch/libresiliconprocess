...
In order to remove the initial naturally grown silicon dioxide from the wafer acid is being applied to the wafer.
...
Hydrofluoric acid (HF) is used to remove native silicon dioxide from wafers. Since it acts quickly, one needs to only expose the wafer fro a short time ("dip"). \\
...
\begin{center}
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.2, every node/.style={transform shape}]
		...
		\fill[orange] (0,0) rectangle (15,10);
		% substrate
		\fill[gray] (0.25,0.5) rectangle (7.25,7.25);
	\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.2, every node/.style={transform shape}]
		...
		\fill[orange] (0,0) rectangle (15,10);
		% substrate
		\fill[YellowOrange] (0.25,0.5) rectangle (7.25,7.25);
	\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\end{tikzpicture}
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.2, every node/.style={transform shape}]
		\fill[BrickRed] (0,0) rectangle (15,10);
	\end{tikzpicture}
...
\begin{center}
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.2, every node/.style={transform shape}]
		...
		% resist
		\fill[orange] (0,2.7) rectangle (15,3.3);
	\end{tikzpicture}
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.2, every node/.style={transform shape}]
		\fill[orange] (0,0) rectangle (15,10);
	\end{tikzpicture}
