...
\begin{minipage}[t]{0.45\textwidth}
	...
	as well as emdedded systems reliable over large temperature and voltage supply ranges. Fitting for many applications in infrastructure,
...
\begin{minipage}[t]{0.45\textwidth}
	\begin{itemize}[itemsep=0pt]
		...
		\item Wide supply voltage range from +3.0 V to +18 V (max. +40V)
...
\end{minipage}\hspace{20pt}\begin{minipage}[t]{0.45\textwidth}
	\begin{itemize}[itemsep=0pt]
		...
		\item ESD protected
		\item Low-noise NMOS/PMOS transistors
		\item High-reliability NVM using SONOS technology
		\item 7 corner case models (typical / worst / best) - BSIM3v3 (MOS, BJT, RES, CAP)
