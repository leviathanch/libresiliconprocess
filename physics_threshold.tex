...
Q_b
=
\sqrt{2 \epsilon_{Si} q N_A ( \left| 2 \phi_F \right| + V_{SB}) }
\end{equation}
...
=
V_{th} ln\left(\frac{N_i}{n}\right)
\end{equation}
...
Q_b
=
2 \sqrt{\epsilon_{Si} q V_{th} ln\left(\frac{N_{implant}}{N_{inert}}\right) \cdot N_{implant} }
\end{equation}
