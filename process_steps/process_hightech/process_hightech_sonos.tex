...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/sonos.lto1_depositon.b.tex}
	\end{tikzpicture}
	\caption{Thin oxide}
\end{figure}
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/sonos.lto2_depositon.a.tex}
	\end{tikzpicture}
	\drawStepArrow{LTO deposition}
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/sonos.lto2_depositon.b.tex}
	\end{tikzpicture}
	\caption{Thin oxide}
\end{figure}
...
\begin{figure}[H]
	...
	\drawStepArrow{}
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossAndTopSection, every node/.style={transform shape}]
		\input{tikz_process_steps/sonos.etching.b.tex}
	\end{tikzpicture}
	\caption{Resist}
\end{figure}
