...
The underlying ONO sandwich, which has been formed in \autoref{sonos_chapter}, which has a spacing of at least a lambda on each side, towards the gate structure, in order to compensate for alignment errors
will first get its LTO densified during the gate oxide formation phase, and will afterwards experience an alignment with the gate structure during dry etching and its over etching phase.

\newpage

\subsection{Gate oxide formation}\label{step_growing_gate_oxide}
