...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossAndTopSectionBig, every node/.style={transform shape}]
		...
		\node at (4,3) {Gate oxide};
		\draw[->] (4,2.8) -- (6,2.2);
		\node at (4,4) {Polysilicon};
		\draw[->] (4,3.8) -- (6,3.2);

		\fill[gateoxide,opacity=0.5] (6.0,2.0) rectangle (8.0,2.3);
		...
		\fill[gateoxide,opacity=0.5] (12.0,2.0) rectangle (14.00,2.3);

		\fill[poly,opacity=0.5] (6.0,2.3) rectangle (8.0,3.0);
		...
		\fill[poly,opacity=0.5] (12.0,2.3) rectangle (14.0,3.0);
	\end{tikzpicture}
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossAndTopSectionBig, every node/.style={transform shape}]
