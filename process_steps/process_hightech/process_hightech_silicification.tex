...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossAndTopSectionBig, every node/.style={transform shape}]
		...
		\node at (6.25,5) {Polycide};
		\draw[->] (6.25,4.8) -- (6.25,3.2);

		\node at (7.5,4) {Silicide};
		\draw[->] (7.5,3.8) -- (7.5,2.2);

		\node at (10,5.5) {Polycide};
		\draw[->] (10,5.2) -- (10,3.7);

		\node at (12.5,4) {Silicide};
		\draw[->] (12.5,3.8) -- (12.5,2.2);

		\node at (13.75,5) {Polycide};
		\draw[->] (13.75,4.8) -- (13.75,3.2);

		\node at (15,4) {Silicide};
		\draw[->] (15,3.8) -- (15,2.2);

		\node at (18,4) {Silicide};
		\draw[->] (18,3.8) -- (18,2.2);

		\fill[gateoxide,opacity=0.5] (5.75,2.0) rectangle (8.0,2.3);
		\filldraw[line width=0, gateoxide,opacity=0.5] (8.75,2.75)--(8.0,2.0)--(8.0,2.3)--(8.75,3.0);
		\fill[gateoxide,opacity=0.5] (8.00,2.75) rectangle (11.25,3.0);
		\filldraw[line width=0, gateoxide,opacity=0.5] (11.25,2.75)--(12.0,2.0)--(12.0,2.3)--(11.25,3.0);
		\fill[gateoxide,opacity=0.5] (12.0,2.0) rectangle (14.25,2.3);

		\fill[poly,opacity=0.5] (5.75,2.3) rectangle (8.0,3.0);
		\filldraw[line width=0, poly,opacity=0.5] (8.75,3.0)--(8.0,2.3)--(8.0,3.0)--(8.75,3.75);
		\fill[poly,opacity=0.5] (8.75,3.0) rectangle (11.25,3.75);
		\filldraw[line width=0, poly,opacity=0.5] (11.25,3.0)--(12.0,2.3)--(12.0,3.0)--(11.25,3.75);
		\fill[poly,opacity=0.5] (12.0,2.3) rectangle (14.25,3.0);

		\fill[silicide,opacity=0.5] (5.75,2.8) rectangle (8.0,3.0);
		\filldraw[line width=0, silicide,opacity=0.5] (8.0,3.0)--(8.0,2.8)--(8.75,3.55)--(8.75,3.75);
		\fill[silicide,opacity=0.5] (8.75,3.55) rectangle (11.25,3.75);
		\filldraw[line width=0, silicide,opacity=0.5] (11.25,3.55)--(11.25,3.75)--(12.00,3.0)--(12.0,2.8);
		\fill[silicide,opacity=0.5] (12.0,2.8) rectangle (14.25,3.0);
	\end{tikzpicture}
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossAndTopSectionBig, every node/.style={transform shape}]
