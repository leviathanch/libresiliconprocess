...
The above mentioned machine is the "Trion RIE Etcher" at the NFF HKUST lab(\autoref{trion_RIE_etch_machine}).
...
For this purpose we use the "Denton Sputter (SPT-Denton)" at HKUST NFF lab (\autoref{denton_sputter_machine}) which has a sputter rate of around 8.8 nm/min for titanium.
...
We use the "AG610 RTP (DIF-R2)" from the HKUST\autoref{thermal_RTAAG610_machine} at 700\degreesC for 240 seconds.
