...
\begin{center}\begin{tabular}{c c}
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.5, every node/.style={transform shape}]
		...
		\node[white] at (3.8,1.4) {p+};
		% (thin) oxide
		\fill[gray] (0,1.6) rectangle (4,1.8);
	\end{tikzpicture} &
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.5, every node/.style={transform shape}]
		...
		\fill[red] (0,1.8) rectangle (4,2);
		% resist 1
		\fill[orange] (0.9,2) rectangle (1.1,3);
		% resist 2
		\fill[orange] (2.6,2) rectangle (2.8,3);
	\end{tikzpicture} &
	Expose and develop pattern from GDS2 file
	\\ \hline
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.5, every node/.style={transform shape}]
...
\begin{center}\begin{tabular}{c c}
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=0.5, every node/.style={transform shape}]
		...
		\fill[Blue] (3.5,1.2) rectangle (4,1.6);
		\node[white] at (3.8,1.4) {p+};
		\fill[DarkGray] (3.5,1.6) rectangle (4,2.6);
		% (thin) oxide 1
		\fill[NormalGray] (0.9,1.6) rectangle (1.1,1.8);
		% (thin) oxide 2
		\fill[NormalGray] (2.6,1.6) rectangle (2.8,1.8);
		% poly h1
		\fill[red] (0.9,1.8) rectangle (1.1,2);
		% poly h1
		\fill[red] (2.6,1.8) rectangle (2.8,2);
		%% oxide growth:
		% (protective) oxide 1
		\fill[DarkGray] (0.5,1.6) rectangle (0.9,2.6);
		% (protective) oxide 2
		\fill[DarkGray] (0.9,2) rectangle (1.1,2.6);
		% (protective) oxide 3
		\fill[DarkGray] (1.1,1.6) rectangle (1.5,2.6);
		% (protective) oxide 4
		\fill[DarkGray] (1.1,1.6) rectangle (1.5,2.6);
		% (protective) oxide 5
		\fill[DarkGray] (2.0,1.6) rectangle (2.6,2.6);
		% (protective) oxide 6
		\fill[DarkGray] (2.6,2) rectangle (2.8,2.6);
		% (protective) oxide 7
		\fill[DarkGray] (2.8,1.6) rectangle (3.5,2.6);
	\end{tikzpicture} &
	Grow oxide
	\\ \hline
\end{tabular}\end{center}
