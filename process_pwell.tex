...
\begin{figure}[H]
	...
	\label{pwell_target}
\end{figure}
The P-well will serve us as an island of n-doped substrate within the p-doped basis substrate.
The dopant dose will be: $2.5\times10^{12}cm^{-2}$

The surface concentration of the P-well ($\approx 1 \times 10^{16} cm^{-3}$) is determined primarily by the need to maintain a sufficiently high surface concentration to prevent field inversion of the n-pwell.
The depth of the P-well ($\approx 4 \mu m$) is then determined by the need to prevent punch-through of the parasitic vertical pnp transistor under worst case bias conditions.
...
You should make the active area always a little bit bigger than the P-well area in order to avoid hitting parts of the trench oxide with your dopant.
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/pwell.1.b.tex}
	\end{tikzpicture}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossAndTopSection, every node/.style={transform shape}]
		\input{tikz_process_steps/pwell.2.a.tex}
	\end{tikzpicture}
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossAndTopSection, every node/.style={transform shape}]
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/pwell.4.a.tex}
	\end{tikzpicture} \\
	\includegraphics[scale=0.01]{down_arrow.png} \\
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/pwell.4.b.tex}
	\end{tikzpicture}
...
\begin{figure}[H]
	\centering
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/pwell.5.a.tex}
	\end{tikzpicture} \\
	\includegraphics[scale=0.01]{down_arrow.png} \\
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
...
\end{figure}
The P-well is implanted with a Phosphorus ($P^{31}$) dose of $2.5\times10^{12}cm^{-2}$ at an energy of 100 KeV.
...
\begin{figure}[H]
	...
	\includegraphics[scale=0.01]{down_arrow.png} \\
	\begin{tikzpicture}[node distance = 3cm, auto, thick,scale=\CrossSectionOnly, every node/.style={transform shape}]
		\input{tikz_process_steps/pwell.8.b.tex}
	\end{tikzpicture}
