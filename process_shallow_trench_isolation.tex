...
The thin layer of silicon dioxide (around 1\um) is grown in dry ambient for 45 minutes at 1000\degreesC\footnote{\url{http://cleanroom.byu.edu/OxideTimeCalc}} in the diffusion furnace (\autoref{diffusion_furnace_machine}).
